...
%
% $Id: book.tex,v 1.6 2013/11/25 00:33:30 macias Exp $
%
% By:
...
%
\input{config/preamble.tex}    % All definitions, packages, etc. DO NOT
                               % TOUCH THIS LINE 
                               
\input{config/myconfig.tex}    % EDIT IT! to set your specific settings!

\input{config/glossaries.tex}  % EDIT IT to include your glossaries!
...
\input{config/setlanguagedependentissues.tex} % DO NOT TOUCH THIS LINE/FILE
...
\input{cover/cover.tex}                       % DO NOT TOUCH THIS LINE/FILE
...
% snippets (they are defined in the appendix)
...
\input{dedicatoria/dedicatoria.tex}           % EDIT this file
\input{agradecimientos/agradecimientos.tex}   % EDIT this file
...
\input{acronyms/acronymsgl.tex}               % EDIT this file

% Now include symbols (if this is the case)
\input{symbols/symbolsgl.tex}                 % EDIT this file
...
\input{theory/estudioTeorico.tex}
...
%
% END Appendices. Edit/modigy all within this section
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% to use it
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{cover/backpage.tex}                    % EDIT this file if required
