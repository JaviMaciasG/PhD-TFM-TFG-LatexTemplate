...
\begin{itemize}
  ...
  \item \texttt{Book/book.tex}, los capítulos, apéndices, resúmenes, bibliografía y demás fuentes \texttt{.tex} o \texttt{.bib} que utilice realmente el libro.
...
A medida que avances, añade los nuevos capítulos, referencias bibliográficas, figuras, datos o scripts que incorpores al trabajo y registra también la eliminación de los que dejes de utilizar. Antes de cada commit, consulta \texttt{git status} y añade rutas concretas mediante \texttt{git add}; si un fichero ya versionado deja de ser necesario pero quieres conservarlo en tu equipo, puedes retirarlo únicamente del índice mediante \texttt{git rm --cached}.
