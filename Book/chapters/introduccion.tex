...
En GNU/Linux puedes compilar el documento con tu editor de \LaTeX{} preferido o ejecutar directamente desde una terminal la secuencia indicada anteriormente. Ejecuta los comandos desde el directorio \texttt{Book/}.
...
\begin{itemize}
  ...
  \item Documentos PDF preliminares. Puedes insertarlos con \texttt{\textbackslash{}includepdf}. El fichero \texttt{letters/sampleLetter.pdf} muestra cómo incorporar todas las páginas de un documento, y \texttt{letters/sampleLetter-pages.pdf} permite probar la selección de páginas concretas. Estos documentos pueden ser necesarios, por ejemplo, en determinadas tesis doctorales o trabajos fin de máster.
  ...
  \item Definiciones de acrónimos, incluidas desde \texttt{acronyms/defacronymsgl.tex}, y listado correspondiente, configurado en \texttt{acronyms/acronymsgl.tex}. Puedes comentar ambos elementos cuando no utilices acrónimos.
  \item Definiciones de símbolos, incluidas desde \texttt{symbols/defsymbolsgl.tex}, y listado correspondiente, configurado en \texttt{symbols/symbolsgl.tex}. Puedes comentar ambos elementos cuando no utilices símbolos.
  ...
  \item Resumen extendido en español, disponible en \texttt{abstract/resumen-extendido.tex}. Su inclusión está comentada de forma predeterminada; puedes activarla cuando lo requiera tu tipo de trabajo.
  \item Índice general, índice de figuras e índice de tablas, generados desde \texttt{cover/toc+lof+lot.tex}.
  \item Listados adicionales, configurados en \texttt{cover/extralistings.tex}. El ejemplo incluye listados para fragmentos de código, algoritmos y vídeos. Puedes editar o comentar esta configuración si no la necesitas.
  \item Capítulos principales, incluidos desde el directorio \texttt{chapters/}. El ejemplo proporciona una estructura formada por introducción, estudio teórico, desarrollo, resultados y conclusiones. Adáptala libremente al contenido real de tu trabajo.
...
Si no necesitas acrónimos o símbolos, comenta en \texttt{Book/book.tex} las órdenes que incluyen sus definiciones y listados. En ese caso tampoco necesitarás ejecutar \texttt{makeglossaries}.
