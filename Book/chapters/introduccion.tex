...
\begin{itemize}
  \item \textbf{Ghostscript}: genera la copia comprimida del documento cuando se utiliza el objetivo \texttt{all} del \texttt{Makefile}.
  \item \textbf{Inkscape}: convierte automáticamente los diagramas en formato \texttt{svg} a \texttt{pdf}.
  \item \textbf{Dia y \texttt{epspdf}}: convierten automáticamente los diagramas en formato \texttt{dia} a \texttt{pdf}.
  ...
  \item \textbf{Perl}: es necesario para ejecutar \texttt{makeglossaries} en los sistemas que no incluyan ya un intérprete compatible.
\end{itemize}
