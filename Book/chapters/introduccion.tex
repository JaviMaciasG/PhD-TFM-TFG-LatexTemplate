...
No necesitas utilizar \texttt{make} para trabajar con la plantilla. Puedes compilarla desde la terminal o con cualquier editor o herramienta de construcción de \LaTeX{} que permita ejecutar la secuencia descrita en la sección~\ref{sec:compilacion}. El \texttt{Makefile} incluido es únicamente una forma opcional de automatizar el proceso y resulta especialmente cómodo en sistemas GNU/Linux.

\subsection{Compilación}
\label{sec:compilacion}

Antes de compilar el documento, completa la configuración compartida en \texttt{Config/myconfig.tex}. La secuencia completa utilizada por el libro de ejemplo es:
...
Biber genera la bibliografía y \texttt{makeglossaries} genera los listados de acrónimos y símbolos. Si tu documento no contiene bibliografía, acrónimos ni símbolos, puedes omitir las herramientas correspondientes. Las pasadas adicionales de \texttt{pdflatex} permiten actualizar correctamente las referencias cruzadas, los índices, la bibliografía y, cuando existan, los glosarios.

\subsubsection{Compilación desde un editor de \LaTeX{}}

Puedes utilizar TeXstudio, TeXShop u otro editor de \LaTeX{} en cualquiera de los sistemas operativos compatibles. Configura el editor para utilizar \texttt{pdflatex} como compilador, Biber como procesador de la bibliografía y, únicamente si utilizas acrónimos o símbolos, \texttt{makeglossaries} para generar sus listados. Después, realiza las dos pasadas finales de \texttt{pdflatex}.

Algunos editores permiten definir una orden o cadena de construcción personalizada que ejecuta automáticamente todo el proceso. Otros proporcionan órdenes separadas para \LaTeX{}, la bibliografía y los glosarios; en ese caso, ejecútalas respetando el orden indicado anteriormente. El fichero principal que debes abrir y compilar es \texttt{Book/book.tex}.
...
No necesitas instalar \texttt{make} para trabajar con la plantilla en Windows. Si quieres utilizar el \texttt{Makefile}, puedes hacerlo desde un entorno compatible que proporcione las herramientas requeridas, como WSL, aunque normalmente te resultará más sencillo configurar la cadena de compilación en el propio editor.
...
En macOS puedes utilizar MacTeX junto con TeXShop, TeXstudio u otro editor compatible. Configura la cadena de construcción para incluir \texttt{pdflatex}, Biber y, si utilizas acrónimos o símbolos, \texttt{makeglossaries} en el orden indicado anteriormente.

Si tu editor no actualiza correctamente los acrónimos o símbolos, ejecuta manualmente \texttt{makeglossaries book} desde el directorio \texttt{Book/} y realiza después dos nuevas pasadas de \texttt{pdflatex}. No necesitas borrar el resto de los ficheros del proyecto para regenerar los glosarios.
