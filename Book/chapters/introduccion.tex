...
La estructura del documento principal se define en \texttt{Book/book.tex}. En este fichero puedes añadir, eliminar, comentar o reordenar los distintos elementos mediante sus correspondientes órdenes \texttt{\textbackslash{}input} o \texttt{\textbackslash{}includepdf}. Los ejemplos incluidos no constituyen una estructura obligatoria: adáptalos a la normativa y a las necesidades de tu trabajo.
...
Además de editar los ficheros incluidos, revisa \texttt{Book/book.tex} para comentar los elementos que no necesites y añadir tus propios capítulos, apéndices o documentos externos. Cuando incorpores un PDF mediante \texttt{\textbackslash{}includepdf}, mantén la orden \texttt{\textbackslash{}clearemptydoublepage} posterior para que el siguiente elemento comience en la página adecuada.
