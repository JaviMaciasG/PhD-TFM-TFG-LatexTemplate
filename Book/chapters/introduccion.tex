...
\label{sec:herramientas-opcionales}
...
El \texttt{Makefile} descrito en el apartado~\ref{sec:compilacion-makefile} puede convertir automáticamente fuentes \texttt{dia}, \texttt{svg} y \texttt{eps} a PDF cuando están instaladas las herramientas opcionales descritas en el apartado~\ref{sec:herramientas-opcionales}. Los PDF generados pueden incluirse después como cualquier otra figura.
