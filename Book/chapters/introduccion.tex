...
En GNU/Linux puedes compilar el documento con tu editor de \LaTeX{} preferido o ejecutar directamente desde una terminal la secuencia indicada anteriormente. Los comandos deben ejecutarse desde el directorio \texttt{Book/}.

Si prefieres automatizar el proceso mediante \texttt{make}, consulta el apartado «Compilación mediante el \texttt{Makefile}», donde se describen el procedimiento y los objetivos disponibles.
