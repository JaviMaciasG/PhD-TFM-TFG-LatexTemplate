...
\begin{itemize}
  ...
  \item Capítulos principales, incluidos desde el directorio \texttt{chapters/}. Esta será tu principal zona de trabajo. El ejemplo proporciona una estructura formada por introducción, estudio teórico, desarrollo, resultados y conclusiones; adáptala libremente al contenido real de tu trabajo.
  ...
  \item Apéndices, agrupados mediante el entorno \texttt{appendices}. El libro de ejemplo incluye \texttt{appendix/manual.tex}, \texttt{appendix/herramientas.tex} y \texttt{appendix/versiones.tex}; edítalos, añade otros nuevos u omítelos según las necesidades de tu trabajo.
