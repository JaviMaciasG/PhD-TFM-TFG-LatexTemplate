...
\begin{itemize}
  ...
  \item Capítulos principales, incluidos desde el directorio \texttt{chapters/} mediante \texttt{chapters/contents.tex}. El documento distribuido contiene esta guía, un capítulo de elementos básicos y otro de figuras y tablas. Cuando prepares tu trabajo, sustituye esta selección por tus propios capítulos o utiliza el esqueleto académico disponible en \texttt{chapters/bare/}.
  ...
  \item Apéndices, agrupados mediante el entorno \texttt{appendices} e incluidos desde \texttt{appendix/contents.tex}. El documento distribuido dedica un apéndice al código fuente, los algoritmos y los listados adicionales, y otro a ejemplos avanzados de composición. Puedes reemplazarlos, añadir otros nuevos u omitirlos según las necesidades de tu trabajo.
