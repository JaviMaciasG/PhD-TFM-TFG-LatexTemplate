...
\label{cha:figuras-tablas}


\section{Figuras de uso habitual}
\label{sec:figuras-habituales}

Este capítulo presenta ejemplos de figuras y tablas que pueden adaptarse a la mayoría de los documentos. Los casos que requieren una composición más elaborada se reúnen en el apéndice~\ref{cha:ejemplos-avanzados}.
...
Los ejemplos avanzados de figuras y tablas, incluidas las tablas multipágina y apaisadas, las figuras rodeadas por texto y las composiciones con numerosas subfiguras, se encuentran en el apéndice~\ref{cha:ejemplos-avanzados}.
