...
\texttt{\textbackslash{}myLanguage}. A partir de ella, el sistema
...
\item Nombre del autor del trabajo (variable \texttt{\textbackslash{}myAuthorFullName}).
...
\item Departamento en el que se realiza el trabajo (variable
  \texttt{\textbackslash{}myDepartment}, en español, y \texttt{\textbackslash{}myDepartmentEnglish}, en inglés).
...
\item Nombre del primer (o único, en su caso) director del trabajo
  (variable \texttt{\textbackslash{}myFirstAdvisorFullName}).
\item Nombre del segundo (en su caso) director del trabajo (variable \texttt{\textbackslash{}mySecondAdvisorFullName}).
