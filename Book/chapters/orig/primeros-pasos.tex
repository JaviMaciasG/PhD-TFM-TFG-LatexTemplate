...
En este capítulo te acompañamos desde la preparación del entorno hasta la generación del primer PDF. Primero revisaremos los requisitos necesarios y después explicaremos cómo configurar la compilación en GNU/Linux, Windows, macOS y Overleaf. Para empezar no necesitas conocer el \texttt{Makefile} ni utilizar una terminal: puedes trabajar con tu editor habitual de \LaTeX{}.
...
Ya sabes qué herramientas necesita la plantilla y cómo generar el documento desde tu editor habitual en GNU/Linux, Windows o macOS, o mediante Overleaf. Recuerda que Biber es necesario para la bibliografía y que solo tendrás que ejecutar \texttt{makeglossaries} cuando utilices acrónimos o símbolos; el siguiente paso es adaptar las variables descritas en el capítulo~\ref{cha:configuracion}.
