...
\begin{itemize}
  ...
  \item \textbf{Trabajos fin de grado}: \texttt{GITT}, \texttt{GIEC}, \texttt{GIT}, \texttt{GIST}, \texttt{GIC}, \texttt{GII}, \texttt{GMC}, \texttt{GIS}, \texttt{GSI}, \texttt{GISI}, \texttt{GIEAI} y \texttt{GITI}. \texttt{GSI} se conserva como identificador histórico del grado al que sucedió \texttt{GISI}.
