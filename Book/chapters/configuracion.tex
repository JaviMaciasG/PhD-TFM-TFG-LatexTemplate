...
La definición completa de cada identificador se mantiene en \texttt{Config/degrees.tex}, mientras que \texttt{Config/layout-profiles.tex} reúne las portadas y contraportadas asociadas. Si quieres añadir una titulación nueva, tendrás que declararla en el registro y proporcionar un perfil con los textos y cubiertas institucionales necesarios; no basta con escribir un identificador nuevo en \texttt{\textbackslash{}myDegree}.

Las variables \texttt{\textbackslash{}myUniversity}, \texttt{\textbackslash{}myUniversityAcronym}, \texttt{\textbackslash{}mySchool}, \texttt{\textbackslash{}myDepartment} y \texttt{\textbackslash{}myDepartmentEnglish} describen la institución de forma genérica. Por tanto, también sirven para incorporar otras escuelas o departamentos de una misma universidad sin crear variables específicas. Para \texttt{ITIURJC}, utiliza \texttt{Universidad Rey Juan Carlos}, \texttt{URJC}, \texttt{Escuela Superior de Ciencias Experimentales y Tecnología} y el nombre del departamento correspondiente.
