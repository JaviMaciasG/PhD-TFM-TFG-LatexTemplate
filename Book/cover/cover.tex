...
{
  \input{cover/portada-tfg-uah-2024.tex}
...
%      \input{cover/portada-tfm-uah-antigua.tex}
      ...
      }
      {
        \ifthenelse{\equal{\myDegree}{MUC}}
          {
          \input{cover/portada-tfm-ciberseguridad-uah-2026.tex}
    %      \input{cover/portada-tfm-uah-antigua.tex}
          \input{cover/cover-pfc-tfg-tfm-uah.tex}
          }
          {
          ...
          \ifthenelse{\equal{\myDegree}{MUANBD}}
            {
            \input{cover/portada-tfm-normativa-uah.tex}
      %      \input{cover/portada-tfm-uah-antigua.tex}
            \input{cover/cover-pfc-tfg-tfm-uah.tex}
            }
            {
              ...
              }
              {
                ...
                \input{cover/portada-tfm-normativa-eps.tex}
                \input{cover/cover-pfc-tfg-tfm-uah.tex}
