...
%\input{acknowledgements/agradecimientos.tex}  % EDIT this file or
                                              % comment it out
                                              % (Página de agradecimientos oculta)
...
% Compulsory for TFGs/PFCs at UAH
%\input{abstract/resumen-extendido.tex}        % EDIT this file
                                              % (Resumen extendido oculto)
...
% Pliego de condiciones and Presupuesto are included as appendices
% (appendix/pliego-condiciones.tex and appendix/presupuesto.tex) below.
...
% Código es el anexo principal y el único visible por ahora. El resto
% quedan ocultos (descomentar para reactivarlos individualmente).
\begin{appendices}
  \input{appendix/codigo.tex}
%  \input{appendix/planos-diagramas.tex}
%  \input{appendix/pliego-condiciones.tex}
%  \input{appendix/presupuesto.tex}
%  \input{appendix/manual-instalacion-usuario.tex}
\end{appendices}
%
