...
1. ESTUDIANTE (\MakeUppercase{\mybookAutorOrAutora})

\begin{figure}[H]
  \begin{tabular}{|p{0.7\textwidth}|p{0.3\textwidth}|}
    \hline
    APELLIDOS Y NOMBRE: & DNI:\\
    \mybookauthor & \mybookDNIOpenPublishing \\
    \hline
...
2. \MakeUppercase{\mybookTutorOrTutores{}} DEL TRABAJO FIN DE MÁSTER

\begin{figure}[H]
  \begin{tabular}{|p{0.7\textwidth}|p{0.3\textwidth}|}
    \hline
    APELLIDOS Y NOMBRE: & DNI:\\
    \mybookNameFirstAdvisor & \mybookDNIFirstAdvisor \\
    \mybookNameSecondAdvisor & \mybookDNISecondAdvisor \\
    \hline
    \multicolumn{2}{|l|}{DEPARTAMENTO O INSTITUCIÓN:} \\
    \multicolumn{2}{|l|}{\mybookdepartment} \\
    \hline
  \end{tabular}
\end{figure}
...
\begin{figure}[H]
  \begin{tabular}{|p{0.5\textwidth}|p{0.5\textwidth}|}
    \hline
    \footnotesize{Firmado: \expandafter\makefirstuc\expandafter{\mybookElOrLa} \mybookAutorOrAutora{}} & Firmado: \footnotesize{\mybookElOrLos{} \mybookTutorOrTutores{} del Trabajo Fin de Máster:}\\
