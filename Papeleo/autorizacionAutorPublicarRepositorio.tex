...
\expandafter\makefirstuc\expandafter{\mybookAutorElOrLa}
\mybookAutorOrAutora{} \mybookAutorDonOrDona{}. \myAuthorFullName, con DNI
\myAuthorDNI, \mybookAutorAdscritoOrAdscrita{} a la
\myUniversity{} como \mybookAlumnoOrAlumna, DECLARA que es \mybookAutorElOrLa{} titular de los
...
En caso de ser cotitular, \mybookAutorElOrLa{} \mybookAutorOrAutora{} declara
...
obra, \mybookAutorElOrLa{} \mybookAutorOrAutora{} declara que tiene la
...
\item El repositorio no asume la titularidad de la obra, que sigue
  correspondiendo \mybookAutorAlOrALa{} \mybookAutorOrAutora{}. Sin embargo,
...
\begin{tabularx}{\textwidth}{XcX}
  ...
  \mybookvicerrectorinvestigacion{} & ~ & \mybookAutorDonOrDona{}. \myAuthorFullName \\
