...
% Long underline spanning the remaining width of the current line.
\usepackage{calc}
\newlength{\remaining}
...
\begin{center}
  ...
  \Large\textbf{SOLICITUD DE ANTEPROYECTO \MakeUppercase{\myWorkTypeFull}}
...
\begin{spacing}{1.0}
  \begin{tabularx}{\textwidth}{X}
%    \MakeUppercase{\wordDirectorOrDirectores}: \myAdvisors \\
