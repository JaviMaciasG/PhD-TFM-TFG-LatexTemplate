...
{
\newcommand{\mybookadvisors}{\myFirstAdvisorFullName{}}
...
{
\newcommand{\mybookadvisors}{\myFirstAdvisorFullName{} y \mySecondAdvisorFullName{}}
...
\title{Anteproyecto de \mybookworktypefull}        \date{\myThesisProposalDate}                         \author{\myAuthorFullName}
...
\maketitle
 ...
 \begin{description}                                \item[Título:] \mybooktitle                        \item[Departamento:] \myDepartment             \item[Autor:] \myAuthorFullName                        \item[\expandafter\makefirstuc\expandafter{\mybookTutorOrTutores}:] \mybookadvisors                    \end{description}                                 
