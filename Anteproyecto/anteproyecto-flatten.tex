...
\newcommand{\contactauthor}{\mybookauthor~\textless\href{mailto:\myAuthorEmail}{\myAuthorEmail}\textgreater}
...
\hypersetup
{
  pdfauthor={\mybookauthor~\textless\href{mailto:\myAuthorEmail}{\myAuthorEmail}\textgreater},
...
\maketitle
 ...
 \begin{description}                                \item[Título:] \mybooktitle                        \item[Departamento:] \myDepartment             \item[Autor:] \mybookauthor                        \item[\expandafter\makefirstuc\expandafter{\mybookTutorOrTutores}:] \mybookadvisors                    \end{description}                                 
