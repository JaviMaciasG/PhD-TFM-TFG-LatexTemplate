...
%
% $Id: autorizacionAutorPublicarRepositorio.tex,v 1.7 2015/05/20 14:02:46 macias Exp $
%
% By:
...
\expandafter\makefirstuc\expandafter{\mybookElOrLa} \mybookAutorOrAutora{}
\mybookDonOrDona{}. \mybookauthor, con DNI \mybookDNIOpenPublishing,
adscrito/a a la \mybookuniversity{} como \mybookFigure, DECLARA que es
el titular de los derechos de propiedad intelectual, objeto de la
presente cesión, en relación con la obra: ``\mybooktitle'', que ésta es
una obra original, y que ostenta la condición de \mybookAutorOrAutora{} en el sentido que
...
\item La cesión es no-exclusiva, por lo que \mybookElOrLa{}
...
\item La obra se pondrá a disposición de los usuarios para que hagan de
  ella un uso justo y respetuoso con los derechos \mybookDelOrDeLa{}
...
\item La Universidad no revisará el contenido de las obras, que en todo
  caso permanecerá bajo la responsabilidad exclusiva \mybookDelOrDeLa{}
  \mybookAutorOrAutora{}.
\item La Universidad no estará obligada a ejercitar acciones legales en
  nombre \mybookDelOrDeLa{} \mybookAutorOrAutora{} en el supuesto de
...
\flushright{En Alcalá de Henares, a \today}
...
\begin{tabularx}{\textwidth}{XcX}
  ...
  Excma. Sra. María Luisa Marina Alegre & ~ & \mybookDonOrDona{}. \mybookauthor \\
