...
\item Why use it (or whatâs wrong with MS-Word) 
\item Terminology 
...
\item Document structure 
	...
	\item Using packages (or whatâs with this âundefined control sequenceâ!)
...
\begin{itemize} 
  ...
  \item Pronounced leh-tek (k being the sound of Arabic \RL{_h} or Greek $\chi$)
 	\item Takes in \LaTeX\ source and generates a number of outputs (dvi, html, rtf, pdf, ps âŠ)
	\item The output is concerned with placing âboxesâ around the âpageâ 
\item Boxes are combined to form other boxes 
\item Placed using fixed or âelasticâ widths and distances
\end{itemize}
\end{frame}
%----------------------------------------------------------
\begin{frame}[t] % 
...
\frametitle{Introduction (contd.)}
\begin{itemize} 
  \item Whatâs wrong with LaTeX? 
  \item You need to learn how to use it! 
	\item Itâs not completely intuitive (for some) 
\end{itemize}
\end{frame}
\begin{frame}
...
\item update (âŠ file/repository/meta information)  
\end{itemize}
\end{frame}
...
\begin{itemize} 
  ...
  \end{itemize}
  \item Enough talk. Letâs get started!
\end{itemize}
\end{frame}
%----------------------------------------------------------
\begin{frame}[t] % 
