...
%
% $Id: introduccion.tex,v 1.8 2014/06/28 22:08:21 macias Exp $
%
% By:
...
Y también un par de variables para el caso de los TFG's que deseen
aceptar la publicación en abierto:

\begin{itemize}
\item DNI del profesor que firma el acuerdo (variable
  \texttt{\textbackslash{}mybookDNIOpenPublishing}).
\item Nombre del profesor que firma el acuerdo (variable
  \texttt{\textbackslash{}mybookProfNameOpenPublishing}).
\item Figura de profesor que tiene el profesor que firma el acuerdo
