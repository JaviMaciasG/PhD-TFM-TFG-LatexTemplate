...
%
% $Id: introduccion.tex,v 1.9 2014/07/01 15:33:47 macias Exp $
%
% By:
...
\item Nombre del/de los directores del trabajo (variable \texttt{\textbackslash{}mybookadvisors}).
...
Y también variables para el caso de los TFG's y TFM's que deseen aceptar
la publicación en abierto:

\begin{itemize}
\item DNI del autor que firma el acuerdo, que es normalmente el alumno
  (variable \texttt{\textbackslash{}mybookDNIOpenPublishing}).
