...
{
  \newcommand{\wordVocalPrimeroOrPrimera}{Vocal 1º}
}
{
  \newcommand{\wordVocalPrimeroOrPrimera}{Vocal 1ª}
}
      ...
      }
      {
        ...
        }
        {
          \ifthenelse{\equal{\myDegree}{GIEC}}
          {
            ...
            \ifthenelse{\equal{\myLanguage}{spanish}}
            {
              \newcommand{\myWorkTypeFull}{Trabajo de Fin de Grado}
            }
            {
              % This could be translated. I'm leaving this in Spanish...
              % \newcommand{\myWorkTypeFull}{Bachelor's Thesis}
                      ...
                      }
                      {
                        ...
                        }
                        {
                          \ifthenelse{\equal{\myDegree}{MUSEA}}
                          {
                            ...
                            \newcommand{\myDegreefullwrappedUpcase}{\MakeUppercase{Máster Universitario en Sistemas Electrónicos Avanzados}\\\MakeUppercase{Sistemas Inteligentes}}
                                      ...
                                      }
                                      {
                                        ...
                                        }
                                        {
                                          ...
                                          }
                                          {
                                            ...
                                            \ifthenelse{\equal{\myDegree}{GMC}}
                                            {
                                              \newcommand{\myDegreefull}{Grado en Matemáticas y Computación}
                                              \newcommand{\myDegreefullwrapped}{Grado en Matemáticas y Computación}
                                              \newcommand{\myDegreefullwrappedUpcase}{\MakeUppercase{Grado en Matemáticas y Computación}}
                                              \newcommand{\myWorkType}{TFG}
                                              \ifthenelse{\equal{\myLanguage}{spanish}}
                                              {
                                                \newcommand{\myWorkTypeFull}{Trabajo de Fin de Carrera}
                                              }
                                              {
                                                % This could be translated. I'm leaving this in Spanish...
                                                % \newcommand{\myWorkTypeFull}{Master's Thesis}
                                            ...
                                            \newcommand{\myDegreefullwrappedUpcase}{\MakeUppercase{Máster Universitario en Ciberseguridad}}
                                            \newcommand{\myWorkType}{TFM}
                                            \ifthenelse{\equal{\myLanguage}{spanish}}
                                            {
                                            \newcommand{\myWorkTypeFull}{Trabajo Fin de Máster}
                                            ...
                                            \ifthenelse{\equal{\myDegree}{MUANBD}}
                                            {
                                              \newcommand{\myDegreefull}{Máster Universitario en Analítica de Negocio y Big Data}
                                              \newcommand{\myDegreefullwrapped}{Máster Universitario en Analítica de Negocio y Big Data}
                                              \newcommand{\myDegreefullwrappedUpcase}{\MakeUppercase{Máster Universitario en Analítica de Negocio y Big Data}}
                                              \newcommand{\myWorkType}{TFM}
                                              \ifthenelse{\equal{\myLanguage}{spanish}}
                                              {
                                                \newcommand{\myWorkTypeFull}{Trabajo Fin de Máster}
