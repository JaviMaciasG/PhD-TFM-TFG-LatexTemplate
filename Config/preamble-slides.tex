...
\addtobeamertemplate{title page}{}{%
  ...
  \begin{textblock*}{100mm}(0.05cm,-7.9cm)
    \includegraphics[height=1cm]{uah/logoUAHazul.jpg}
  \end{textblock*}
  
  \begin{textblock*}{100mm}(11.3cm,-7.9cm)
    \includegraphics[height=1.cm]{uah/Logo_depeca_azul.jpg}
  \end{textblock*}
...
%    \raisebox{-.15\height}{\includegraphics[height=0.2cm]{shared/logogeintra+pcr.png}} Proyecto Spaces \textemdash~UPM+UAH
  ...
  %   \includegraphics[height=1.06cm]{shared/multilogo-SPACES.png}
  % \end{textblock*}
}
...
\addtobeamertemplate{frametitle}{}{%
  \begin{textblock*}{100mm}(0.965\textwidth,-1cm)
    \includegraphics[height=1.1cm]{uah/logoUAH+DEPECA.png}
