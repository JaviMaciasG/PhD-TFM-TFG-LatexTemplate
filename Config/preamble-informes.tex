...
% % Define custom section style with a rectangular box
% \titleformat{\section}
%   {\sffamily\Large\bfseries} % Font style
%   {\thesection} % Section number
%   {0.5em} % Space between number and title
%   {\colorsection} % Custom command for the background
%   [\titlerule] % Add a horizontal line after the title

% % Define the rectangle style
% \newcommand{\colorsection}[1]{%
%   \colorbox[HTML]{D9E2F3}{\parbox{\dimexpr\textwidth-2\fboxsep}{#1}}%
% }
...
% % Define custom section format with gray background, black border, and smaller font
% \titleformat{\section}
%   {\normalfont} % No special font modifications
%   {}
%   {0pt}
%   {%
%     \begin{tcolorbox}[
%       colframe=black, % Black border
%       colback=sectiongray, % Gray background
%       boxrule=1pt, % Border thickness
%       arc=0pt, % No rounded corners
%       width=\dimexpr\textwidth\relax, % Full width
%       left=2pt, right=2pt, top=2pt, bottom=2pt, % Padding inside box
%       enlarge left by=-2pt, enlarge right by=-2pt
%     ]
%     \textbf{\small #1} % <-- SMALL FONT (adjustable: \footnotesize, \scriptsize)
%     \end{tcolorbox}%
%   }

%   % Define custom section format with gray background and black border
% \titleformat{\section}
%   {\normalfont} % No special font modifications
%   {}
%   {0pt}
...
%       enlarge left by=-2pt, enlarge right by=-2pt
%     ]
%     \textbf{\large #1} % Make section title bold and slightly larger
%     \end{tcolorbox}%
%   }
...
%       enlarge left by=-2pt, enlarge right by=-2pt
%     ]
%     \textbf{\small #1} % Small font
%     \end{tcolorbox}%
% }

% % Apply the new section format
% \titleformat{\section}
%   {\normalfont} % No special font modifications
%   {} % No automatic numbering
%   {0pt}
%   {\sectionbox} % Calls the custom box command


% Custom section format with reduced padding and spacing
% \newcommand{\sectionbox}[1]{%
%     \begin{tcolorbox}[
%       colframe=black, % Black border
%       colback=sectiongray, % Gray background
...
%       arc=0pt, % No rounded corners
%       width=\dimexpr\textwidth\relax, % Full width
%       left=0pt, right=0pt, top=0pt, bottom=0pt, % Less padding inside box
%       enlarge left by=0pt, enlarge right by=0pt
%     ]
%     \textbf{\small #1} % Small font size
%     \end{tcolorbox}%
% }
...
\newcommand{\sectionbox}[1]{%
    \begin{tcolorbox}[
      ...
      arc=0pt, % No rounded corners
      width=\dimexpr\textwidth\relax, % Full width
      left=2pt, right=2pt, top=-3pt, bottom=-3pt, % ✅ Small padding to stabilize height
      enlarge left by=0pt, enlarge right by=0pt,
      before skip=0pt, after skip=0pt % ✅ Removes extra spacing
    ]
    \strut % ✅ Ensures uniform height across all boxes
    \begin{minipage}[t]{\textwidth} % ✅ Forces fixed height alignment
        \textbf{\small #1}
    \end{minipage}
    \end{tcolorbox}%
}
...
% Reduce spacing between the section and the text
\titlespacing{\section}{0pt}{0pt}{-20pt} % {left}{before}{after}
...
%\setlength\cellspacetoplimit{5pt} % Adjust top padding
%\setlength\cellspacebottomlimit{5pt} % Adjust bottom padding
%%% Local Variables:
%%% TeX-master: "../book"
%%% End:
