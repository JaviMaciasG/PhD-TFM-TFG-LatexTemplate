...
% using UTF-8 encoded acronyms. To simplify your life:
% + If you have the external makeglossaries program, just leave \glossariessystem
%   to be igual to makeglossaries
% + If you don't have the application, or you are using overleaf, set
%   \glossaryessystem to makenoidxglossaries
