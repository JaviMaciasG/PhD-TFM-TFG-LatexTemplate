...
% 
% $Id: preamble.tex,v 1.24 2014/09/22 08:15:28 macias Exp $
% 
% By:
...
\newcommand{\topline}{%
  \tikz[remember picture,overlay] {%
    \filldraw[fill=red,draw=red] ([xshift=0.3cm,yshift=-1.4cm]current page.north west) rectangle ([xshift=0.6\paperwidth,yshift=-1.5cm]current page.north west);
%    \filldraw[fill=green!20!white, draw=green!40!black] (0,0) rectangle (2,1);
  }
  %   \draw[red,ultra thick] ([xshift=0.3cm,yshift=-1.4cm]current page.north west)
  %   -- ([xshift=0.6\paperwidth,yshift=-1.4cm]current page.north west);}
  \tikz[remember picture,overlay] {%
    \draw[red,thick] ([xshift=0.6\paperwidth,yshift=-1.4cm]current page.north west)
    -- ([xshift=0.985\paperwidth,yshift=-1.4cm]current page.north west);}
  \tikz[remember picture,overlay] {%
    \draw[red,thick] ([xshift=0.3cm,yshift=0.35cm]current page.south west)
    -- ([xshift=0.985\paperwidth,yshift=0.35cm]current page.south west);}
