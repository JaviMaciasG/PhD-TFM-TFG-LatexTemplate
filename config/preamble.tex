...
%
% $Id: preamble.tex,v 1.12 2013/11/25 00:33:31 macias Exp $
%
% By:
...
% Let's define some styles for listings:
% minimizar fragmentado de listados (from http://www.rafalinux.com/?p=599)
%\lstnewenvironment{codelisting}[1][]
%{\lstset{#1}\pagebreak[0]}{\pagebreak[0]}
% This was using old float package
\usepackage{float}
\floatstyle{plain} % optionally change the style of the new float
\newfloat{codefloat}{H}{cod}[chapter]
% Now let's use newfloat
%\usepackage{newfloat}
