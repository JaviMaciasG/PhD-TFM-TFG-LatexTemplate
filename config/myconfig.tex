...
%
% $Id: myconfig.tex,v 1.13 2014/07/01 08:38:11 macias Exp $
%
% By:
...
% Por TFGs paperwork
\newcommand{\mybookDNIOpenPublishing}{12345678-L} % Required for TFG's
                                % paperwork, must be the DNI of the advisor
\newcommand{\mybookProfNameOpenPublishing}{\mybookadvisors} % Required for TFG's
                                % paperwork, must be the name of the
                                % advisor signing the agreement to open
                                % publish the document. Initially it is
                                % the name of the advisor (if just
                                % one). If there are more than one
                                % advisors, this should be edited.
\newcommand{\mybookProfFigure}{Profesor Titular de Universidad} % Required
                                % for TFG's: the type of professor
